...
export const setColors = updater<[number, number, number][]>(ActionType.SET_COLORS);
...
export const setLevelTime = updater<number>(ActionType.SET_LEVEL_TIME);
export const setCanvasPerColorTime = updater<number>(ActionType.SET_CANVAS_PER_COLOR_TIME);
export const setCanvasBaseTime = updater<number>(ActionType.SET_CANVAS_BASE_TIME);
